...
const Header: React.FC<HeaderProps> = ({ onClick, onToggle }) => {
    ...
    return (
        <header className="sticky top-0 flex w-full bg-white border-gray-200 z-9 lg:border-b">
            <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
                <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
                    ...
                    <button
                        onClick={onClick}
                        className="items-center justify-center hidden w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99 lg:flex lg:h-11 lg:w-11 lg:border"
                    >
                        <svg
