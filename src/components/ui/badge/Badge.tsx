...
const Badge: React.FC<BadgeProps> = ({
    ...
    const variants = {
        ...
        outline: {
            ...
            indigo: "border border-indigo-700 text-indigo-700",
            secondary: "border border-indigo-700 text-indigo-700",
        }
    };
    ...
    const colorStyles =
        variant !== "dot" ? variants[variant][color] : variants.light[color];
