    ...
    const getSelectStyles = (): StylesConfig<Option> => {
        return {
            control: (baseStyles, state) => {
                let inputClasses = `font-secondary h-11 w-full rounded-lg border appearance-none px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30`;
                ...
                if (disabled || state.isDisabled) {
                    ...
                    inputClasses += ` bg-transparent text-gray-800 border-brand-300 ring-3 ring-brand-500/20 dark:border-brand-800 dark:text-white/90`;
                } else {
                    inputClasses += ` bg-transparent text-gray-800 border-gray-300 dark:border-gray-700 dark:text-white/90`;
                }
