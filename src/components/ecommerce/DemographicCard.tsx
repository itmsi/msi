      ...
      <div className="flex justify-between">
        ...
        <div className="relative inline-block">
          <button className="dropdown-toggle" onClick={toggleDropdown}>
            <MoreDotIcon className="text-gray-400 hover:text-gray-700:text-gray-300 size-6" />
          </button>
          <Dropdown
            isOpen={isOpen}
          ...
          >
            <DropdownItem
              ...
              className="flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700:bg-white/5:text-gray-300"
            >
              View More
            </DropdownItem>
            <DropdownItem
