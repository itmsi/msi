...
import { quotationManage } from '@/pages/Quotation/Manage/language/quotationManage';
...
const ManageQuotations: React.FC = () => {
        ...
        () => [
            {
                ...
                <>
                    <a
                        href={buildPath(`/quotations-iti/manage/edit/${row.manage_quotation_id}`)}
    ...
    return (
        <>
            <PageMeta
                title="Manage ITI Quotations - Motor Sights International"
                description="Manage ITI Quotations - Motor Sights International"
            ...
            <div className="bg-white shadow rounded-lg">
                ...
                <div className="px-6 py-4 border-b border-gray-200">
                    <div className="flex justify-between items-center">
                        <div>
                            <h3 className="text-lg leading-6 font-primary-bold text-gray-900">{langField('manageQuotationsITI')}</h3>
                            <p className="mt-1 text-sm text-gray-500">{langField('manageDescription')}</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <PermissionGate permission="create">
                                <Button
                                    onClick={() => navigate(buildPath('/quotations-iti/manage/create'))}
