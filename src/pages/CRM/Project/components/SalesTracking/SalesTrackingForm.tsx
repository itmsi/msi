...
import { ProjectAttachment, SalesTrackingFormData } from '../../types/salesTracking';
...
const SalesTrackingForm: React.FC<SalesTrackingFormProps> = ({
    formData,
    onFormDataChange,
    onSubmit,
    isSubmitting = false,
...
export default SalesTrackingForm;