            ...
            cell: (row) => (
                <div className=" items-center gap-3 py-2">
                    <div className="flex flex-wrap gap-1 mt-1 gap">
                        <span className="inline-flex items-center justify-center border rounded-md font-medium px-2 bg-blue-100 text-blue-800 border-blue-200">{`${row.island_name}`}</span>
                        <span className="inline-flex items-center justify-center border rounded-md font-medium px-2 bg-green-100 text-green-800 border-green-200">{`${row.group_name}`}</span>
                        <span className="inline-flex items-center justify-center border rounded-md font-medium px-2 bg-orange-100 text-orange-800 border-orange-200">{`${row.area_name}`}</span>
                        <span className="inline-flex items-center justify-center border rounded-md font-medium px-2 bg-purple-100 text-purple-800 border-purple-200">{`${row.iup_zone_name}`}</span>
                        <span className="inline-flex items-center justify-center border rounded-md font-medium px-2 bg-pink-100 text-pink-800 border-pink-200">{`${row.iup_segmentation_name}`}</span>
                    </div>
                </div>
            ),
            sortable: false,
