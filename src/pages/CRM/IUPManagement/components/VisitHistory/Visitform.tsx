...
const VisitForm: React.FC<VisitFormProps> = ({
    ...
    return (
        <div className="p-5">
            <div className={`transition-all duration-200 rounded-2xl ${!editingId ? ' border border-green-300' : 'border border-slate-300'}`}>
                <h3 className="text-md font-primary-bold px-5 py-4 border-b border-slate-300">
