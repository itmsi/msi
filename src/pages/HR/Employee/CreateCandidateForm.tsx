...
import LoadingSpinner, { LoadingOverlay } from '@/components/common/Loading';
        ...
        <div className="mx-auto">
            ...
            >
                <div className='relative'>
                    {submitting &&
                        <div className={`flex items-center justify-center min-h-screen absolute top-0 bottom-0 left-0 right-0 bg-white/70 z-1`}>
                            <LoadingOverlay
                        ...
                        <FormSection title="Notes & Documents">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                ...
                                <FileUpload
                                    ...
                                    hasDownloadButton
                                    description="Format: JPG, JPEG, PNG"
                                />
