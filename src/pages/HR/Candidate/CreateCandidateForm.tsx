    ...
    return (<>
        ...
        <div className="mx-auto">
            ...
            <form
                ...
                className={`${!isEdit ? 'p-6 bg-white rounded-xl border border-gray-200' : ''} ${validated ? 'was-validated' : ''
                    }`}
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 col-span-2">
                        {/* Group */}
                        <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 col-span-2">
                        {/* Gender */}
                        <div>
