...
export default function QuotationItemFields({
    formData,
    masterData,
    errors,
    onAddItem,
    ...
    const itemColumns: TableColumn<QuotationFormItem>[] = [
        ...
        {
            name: 'Description',
            selector: (row: QuotationFormItem) => row.description || '-',
            cell: (row, idx) => (<>
        ...
        {
            name: 'Quantity',
            selector: (row: QuotationFormItem) => row.qty || 0,
            cell: (row, index) => (<>
                {(formData.custbody_me_approval_status === 2 || formData.custbody_me_approval_status === 3) || (formData.custbody_me_approval_status === 1 && formData.nextapprover !== null) ? (
                    <p className="mt-1 text-gray-800 text-md min-h-[42px] flex items-center">
                        {row.qty || 'N/A'}
        ...
        {
            name: 'Rate',
            selector: (row: QuotationFormItem) => row.rate || 0,
            cell: (row, index) => (<>
                {(formData.custbody_me_approval_status === 2 || formData.custbody_me_approval_status === 3) || (formData.custbody_me_approval_status === 1 && formData.nextapprover !== null) ? (
                    <p className="mt-1 text-gray-800 text-md min-h-[42px] flex items-center">
        ...
        {
            name: 'Amount',
            selector: (row: QuotationFormItem) => row.amount || 0,
            cell: (row, index) => (<>
        ...
        {
            name: 'Tax Code',
            selector: (row: QuotationFormItem) => row.taxcode || 'N/A',
            cell: (row, index) => (<>
                {(formData.custbody_me_approval_status === 2 || formData.custbody_me_approval_status === 3) || (formData.custbody_me_approval_status === 1 && formData.nextapprover !== null) ? (
                    <p className="mt-1 text-gray-800 text-md min-h-[42px] flex items-center">
        ...
        {
            name: 'Department',
            selector: (row: QuotationFormItem) => row.department_name || 'N/A',
            cell: (row, index) => (<>
                {(formData.custbody_me_approval_status === 2 || formData.custbody_me_approval_status === 3) || (formData.custbody_me_approval_status === 1 && formData.nextapprover !== null) ? (
                    <p className="mt-1 text-gray-800 text-md min-h-[42px] flex items-center">
        ...
        {
            name: 'Class',
            selector: (row: QuotationFormItem) => row.class || 0,
            cell: (row, index) => (<>
                {(formData.custbody_me_approval_status === 2 || formData.custbody_me_approval_status === 3) || (formData.custbody_me_approval_status === 1 && formData.nextapprover !== null) ? (
                    <p className="mt-1 text-gray-800 text-md min-h-[42px] flex items-center">
                        {row.class_name || 'N/A'}
        ...
        {
            name: 'Location',
            selector: (row: QuotationFormItem) => row.location || 0,
            cell: (row, index) => (<>
                {(formData.custbody_me_approval_status === 2 || formData.custbody_me_approval_status === 3) || (formData.custbody_me_approval_status === 1 && formData.nextapprover !== null) ? (
                    <p className="mt-1 text-gray-800 text-md min-h-[42px] flex items-center">
        ...
        ...(formData.custbody_me_approval_status === 1 || !formData.custbody_me_approval_status ? [createActionsColumn([
            {
                icon: MdDeleteOutline,
                onClick: (row: QuotationFormItem) => {
                    onRemoveItem(row.id || '')
                },
                ...
                {(formData.custbody_me_approval_status === 1 || !formData.custbody_me_approval_status) && (<>
                    ...
                    <div className="flex gap-4 mb-6">
                        <div className="flex-1">
                            <Label htmlFor="quo-add-item">Select Item to Add</Label>
                            <CustomAsyncSelect
                                name="add_item"
                                disabled={!formData.subsidiary}
...
export const QuotationInvoiceSummary: React.FC<{ items: QuotationFormItem[], currency: string, serverTotal?: number }> = ({ items, currency, serverTotal }) => {
    // Helper to ensure numeric value  
    const toNumber = (value: any): number => {
