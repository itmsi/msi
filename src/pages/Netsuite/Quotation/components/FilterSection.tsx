...
const FilterSection: React.FC<FilterSectionProps> = ({
    ...
    const handleDateRangeChange = (item: any) => {
        ...
        if (selection.startDate && selection.endDate) {
            ...
            onFilterChange('tran_date_from', formattedStart);
            onFilterChange('tran_date_to', formattedEnd);
        }
    };
    ...
    const handleClearDateRange = () => {
        setSelectedDateRange({ startDate: '', endDate: '' });
        setDateRangeState([{ startDate: new Date(), endDate: new Date(), key: 'selection' }]);
        onFilterChange('tran_date_from', '');
        onFilterChange('tran_date_to', '');
        setShowDatePicker(false);
    };
